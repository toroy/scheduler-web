...
public class FileUtils {
    ...
    public static String getUploadFilename(String tenantCode, String filename) {
        return String.format("%s/%s/resources/%s",getString(DATA_UPLOAD_BASEDIR_PATH), tenantCode, filename);
    }
    ...
    public static String genZipUncompressDir(){
        ...
        try {
             String configBaseDir = getString(DATA_UPLOAD_BASEDIR_PATH);
    ...
    public static String getResourceViewSuffixs() {
        return getString(RESOURCE_VIEW_SUFFIXES);
    }
