 ...
 *
 */
public class LoginGuavaCacheUtil {
	 ...
	 * 缓存过期时间，单位秒
	 */
	private static int EXPIRE_TIME_SECODDS = 60 * 60 * 24 * 3;
	...
	public static void main(String[] args) throws InterruptedException {
		LoginGuavaCacheUtil.put("test","test");
		String val = LoginGuavaCacheUtil.get("test");
		System.out.println("值:"+val);
		for (int i = 0; i< 200; i++) {
			Thread.sleep(1000);
			val = LoginGuavaCacheUtil.get("test");
			if (val == null) {
