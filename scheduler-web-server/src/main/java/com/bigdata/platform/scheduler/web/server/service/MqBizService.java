...
import com.bigdata.platform.scheduler.web.core.constant.SysConfigConstant;
import com.bigdata.platform.scheduler.web.core.dto.AlarmDto;
...
import com.bigdata.platform.scheduler.web.core.dto.JobDto.ParamContent;
import com.bigdata.platform.scheduler.web.core.dto.MqDto;
...
import com.bigdata.platform.scheduler.web.core.jdbc.client.Operations;
...
import com.bigdata.platform.scheduler.web.core.jdbc.enums.HiveColumnTypeEnum;
import com.bigdata.platform.scheduler.web.core.utils.OkHttp3Utils;
import com.bigdata.platform.scheduler.web.core.utils.SpringBean;
import com.bigdata.platform.scheduler.web.core.utils.SysConfigUtil;
import com.bigdata.platform.scheduler.web.core.vo.CollectDbVO;
import com.bigdata.platform.scheduler.web.core.vo.MqVO;
import com.bigdata.platform.scheduler.web.server.constant.UpdateJobEnums;
import com.bigdata.platform.scheduler.web.server.dto.MqQueryDto;
import com.bigdata.platform.scheduler.web.server.vo.MqEnumVo;
import com.bigdata.platform.scheduler.web.server.vo.MqQueryVo;
...
public class MqBizService {
	...
	public MqEnumVo listEnums() {
		...
		List<JobEnumVo.Content> columnTypes = columnTypeEnums.stream().map(hiveEnum -> {
		...
		List<JobEnumVo.Content> dbs = collectDbVOs.stream().map(collect -> {
			JobEnumVo.Content content = new JobEnumVo.Content();
