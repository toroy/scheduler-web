...
import com.zhugeio.platform.scheduler.web.server.service.GraphBizService;
import com.zhugeio.platform.scheduler.web.server.service.LoggerService;
import com.zhugeio.platform.scheduler.web.server.service.TaskBizService;
import com.zhugeio.platform.scheduler.web.server.vo.JobEnumVo;
import com.zhugeio.platform.scheduler.web.server.vo.LogMapVo;
import com.zhugeio.platform.scheduler.web.server.vo.TaskQueryVo;
...
import com.zhugeio.platform.scheduler.web.server.dto.LastNRowsLogDto;
import com.zhugeio.platform.scheduler.web.server.dto.LoggerDto;
import com.zhugeio.platform.scheduler.web.server.dto.TaskQueryDto;
...
public class TaskController<T> {
	...
	public BaseResult<Map<String, Object>> listTasksByDependId(Long taskId) {
		List<JobEnumVo.Content> contents = graphBizService.listTasksByDependId(taskId);
