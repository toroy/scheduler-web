...
import com.zhugeio.platform.scheduler.web.server.vo.JobOnlineVo;
import com.zhugeio.platform.scheduler.web.server.vo.JobVo;
...
import com.zhugeio.platform.scheduler.web.core.dto.*;
...
import com.zhugeio.platform.scheduler.web.core.jdbc.client.*;
...
import com.zhugeio.platform.scheduler.web.server.dto.ColumnQueryDto;
import com.zhugeio.platform.scheduler.web.server.dto.ExecParamDto;
import com.zhugeio.platform.scheduler.web.server.service.inter.JobEditCallback;
import com.zhugeio.platform.scheduler.web.server.service.inter.JobSaveCallback;
...
public class JobDetailBizService {
	...
	private void getJobOnlineDto(JobOnline job, JobOnlineDto jobDto) {
		...
		if (StringUtils.isNotBlank(job.getFileParamsJson())) {
			jobDto.setFileParams(JSON.parseArray(job.getFileParamsJson(), JobDto.FileParamsContent.class));
		}
