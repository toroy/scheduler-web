...
public interface SparkSqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code distcpDruid}
	 * labeled alternative in {@link SparkSqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterDistcpDruid(SparkSqlBaseParser.DistcpDruidContext ctx);
	/**
	 * Exit a parse tree produced by the {@code distcpDruid}
	 * labeled alternative in {@link SparkSqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitDistcpDruid(SparkSqlBaseParser.DistcpDruidContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SparkSqlBaseParser#writeType}.
	 * @param ctx the parse tree
	 */
	void enterWriteType(SparkSqlBaseParser.WriteTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparkSqlBaseParser#writeType}.
	 * @param ctx the parse tree
	 */
	void exitWriteType(SparkSqlBaseParser.WriteTypeContext ctx);
	/**
