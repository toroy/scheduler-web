...
public interface SparkSqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code distcpDruid}
	 * labeled alternative in {@link SparkSqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDistcpDruid(SparkSqlBaseParser.DistcpDruidContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SparkSqlBaseParser#writeType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWriteType(SparkSqlBaseParser.WriteTypeContext ctx);
	/**
